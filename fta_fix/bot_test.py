...
def deprecated1_old_function():
    ...
    warnings.warn("The 'deprecated1_old_function' is deprecated. Use `deprecated1_new_function` instead",
...
class TestTeleBot:
    ...
    def test_send_file(self):
        file_data = open('files/kitten.jpg', 'rb')
        tb = telebot.TeleBot(TOKEN)
    ...
    def test_edit_message_media(self):
        file_data = open('files/kitten.jpg', 'rb')
        file_data_2 = open('files/rooster.jpg', 'rb')
        tb = telebot.TeleBot(TOKEN)
        ...
        new_msg = tb.edit_message_media(chat_id=CHAT_ID, message_id=msg.message_id,
                                        media=types.InputMediaPhoto(msg.photo[0].file_id,
                                                                    caption='Test editMessageMedia'))
        assert type(new_msg) != bool
